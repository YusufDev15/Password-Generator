...
var passwordLength = parseInt(prompt("Pick a password length between 8-128"));
if (isNaN(passwordLength) || passwordLength < 8 || passwordLength > 128) {  //This if statement has to be false
